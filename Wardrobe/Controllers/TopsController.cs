...
namespace Wardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopPic,TopColor,SeasID,OccID")] Top top)
        {
            ...
            ViewBag.OccID = new SelectList(db.Occasions, "OccID", "OccName", top.OccID);
            ViewBag.SeasID = new SelectList(db.Seasons, "SeasID", "SeasonName", top.SeasID);
            return View(top);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopPic,TopColor,SeasID,OccID")] Top top)
        {
            if (ModelState.IsValid)
            {
