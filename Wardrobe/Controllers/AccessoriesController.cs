...
namespace Wardrobe.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccID,AccName,AccPic,AccColor,SeasID,OccID")] Accessory accessory)
        {
            ...
            ViewBag.OccID = new SelectList(db.Occasions, "OccID", "OccName", accessory.OccID);
            ViewBag.SeasID = new SelectList(db.Seasons, "SeasID", "SeasonName", accessory.SeasID);
            return View(accessory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccID,AccName,AccPic,AccColor,SeasID,OccID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
